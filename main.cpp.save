...
HDC image_mario = txLoadImage("Images\\Ìàðèî.bmp");
HDC image_AJY = txLoadImage("Images\\Ôîí èãðà.bmp");
 ...
 //ìåíþ
    ...
    if(PAGE == "menu")
    {
     ...
     if(PAGE == "ÏÐÀÂÈËÀ")
     {
      ...
      txTextOut(600, 20, "ÏÐÀÂÈËÀ");
      txTextOut(5, 100, "1.ÈÃÐÀÒÜ ÁÅÇ ×ÈÒÎÂ.");
      txTextOut(5, 150, "2.ÂÎ ÂÐÅÌß ÈÃÐÛ ÍÅ ÌÅØÀÒÜ ÏÐÎÒÈÂÍÈÊÓ ÒÀÏ ÒÀÏÀÒÜ ÏÎ ÊÍÎÏÎ×ÊÀÌ ÍÎÓÒÁÓÊÀ.");
     ...
     if(PAGE == "Î ÈÃÐÅ")
     {
      ...
      txTextOut(5, 50, "Ñîçäàòåëü äàííîé èãðû: Ì¸ðòâûé àíàðõèñò");
      txTextOut(5, 100, "Äàííàÿ èãðà íå ÿâëÿåòñÿ ïëàãèàòîì, à ëèøü èäåè ñîçäàòåëÿ");
      txTextOut(5, 150, "Ñäåëàíî â Ðîññèè");
      if(GetAsyncKeyState(VK_ESCAPE))
      {
       PAGE="menu";
      }
