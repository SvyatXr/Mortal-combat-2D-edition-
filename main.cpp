...
Button btn2 = {10, 530, 220, 150, "¬€’Œƒ", true};
Button btn3 = {10, 380, 220, 150, "Œ¡ »√–≈", true};
Button btn4 = {10, 230, 220, 150, "œ–¿¬»À¿", true};
 ...
 //ÏÂÌ˛
    ...
    if(PAGE == "menu")
    {
     ...
     if(PAGE == "œ–¿¬»À¿")
     {
      ...
      txDrawText   (100, 0, 1270, 100, "œ–¿¬»À¿");

      txTextOut(25, 100, "1.»√–¿“‹ ¡≈« ◊»“Œ¬.");
      txTextOut(25, 135, "2.¬Œ ¬–≈Ãﬂ »√–€ Õ≈ Ã≈ÿ¿“‹ œ–Œ“»¬Õ» ” Õ¿∆»Ã¿“‹  ÕŒœ » ÕŒ”“¡” ¿.");
      txTextOut(25, 170, "3.»√–¿“‹ ¡≈« Õ≈√¿“»¬¿.");
      txTextOut(25, 205, "»√–¿ «¿ ¿Õ◊»¬¿≈“—ﬂ œŒ—À≈ “Œ√Œ,  ¿  Œƒ»Õ Ã¿–»Œ œŒ¡≈∆ƒ¿≈“ ƒ–”√Œ√Œ.");

      txDrawText   (100, 250, 1270, 700, "”œ–¿¬À≈Õ»≈ ƒÀﬂ À≈¬Œ√Œ Ã¿–»Œ: \n"
                                         "A-¬À≈¬Œ \n"
                                         "D-¬œ–¿¬Œ \n"
                                         "S-¬¬≈–’ \n"
                                         "W-”ƒ¿– \n"
     ...
     if(PAGE == "Œ¡ »√–≈")
     {
      ...
      txSelectFont ("Arial", 40);
      txTextOut(5, 50, "—ﬁ∆≈“");
      txTextOut(5, 100, "ƒ‚‡ Ï‡ËÓ ÔÓ‰‡ÎËÒ¸ ËÁ-Á‡ Ì‡È‰ÂÌÌÓÈ ËÏË ÒÓÒËÒÍË Ë Ì‡˜‡Î‡Ò¸ ÓÊÂÒÚÓ˜∏ÌÌ‡ˇ ·ËÚ‚‡ Á‡ ÒÓÒËÒÍÛ!");
      txSelectFont ("Arial", 50);
      txTextOut(600, 20, "O »√–≈");
      txSelectFont ("Arial", 35);
      txTextOut(5, 150, "—ÓÁ‰‡ÚÂÎ¸ ‰‡ÌÌÓÈ Ë„˚: <?|?|?|?|?|?|?|?|?|?|?|?|?|?|?|?|?|?|?|?|?>");
      txSelectFont ("Arial", 35);
      txTextOut(5, 200, "ƒ‡ÌÌ‡ˇ Ë„‡ ÌÂ ˇ‚ÎˇÂÚÒˇ ÔÎ‡„Ë‡ÚÓÏ, ‡ ÎË¯¸ Ë‰ÂÂÈ ÒÓÁ‰‡ÚÂÎˇ");
      txSelectFont ("Arial", 35);
      txTextOut(5, 250, "—‰ÂÎ‡ÌÓ ‚ –ÓÒÒËË");
      if(GetAsyncKeyState(VK_ESCAPE))
      {
       PAGE="menu";
      }
     ...
     //»„‡
      ...
      if(PAGE == " ŒÕ≈÷")
      {
          if(GetAsyncKeyState(VK_ESCAPE))
          {
           ...
           if(mario.healthy<10)
             {
                txTextOut(540, 300, "Mario1 ÔÓ·Â‰ËÎ Mario!");
             }
             else if(mario1.healthy<10)
             {
                txTextOut(540, 300, "Mario ÔÓ·Â‰ËÎ Mario1!");
             }
           txTextOut(540, 350, "ƒÎˇ ‚˚ıÓ‰‡ Ì‡ÊÏËÚÂ Esc");
